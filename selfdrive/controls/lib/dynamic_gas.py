...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      y = [0.6, 0.40, 0.38, 0.33, 0.33, 0.32, 0.31, 0.30, 0.27, 0.25, 0.24, 0.24, 0.24, 0.24, 0.24, 0.24, 0.22, 0.20]
      ...
      #km/h[0,   5,    10,   15,   19,  22,   25,   29,   36,   43,   54,   64,   72,   87,   104,  117,  128   144]
      y = [0.85, 0.7, 0.6, 0.43, 0.45, 0.43, 0.43, 0.43, 0.43, 0.43, 0.42, 0.38, 0.34, 0.32, 0.3, 0.28, 0.25, 0.24]
