...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      #km/h[0,  5,    10,    15,   19,  22,  25,  29,  36,  43,   54,   64,   72,   87,   104,  117,  128,  144]
      y = [1.1, 0.88, 0.8, 0.7, 0.6, 0.55, 0.55, 0.55, 0.55, 0.6, 0.65, 0.7, 0.7, 0.7, 0.5, 0.45, 0.44, 0.43]
      self.x_lead_mod_x = [4.1, 6.15, 8.24, 10 , 15 ]
    else:
      #km/h[0,   5,    10,   15,   19,  22,   25,   29,   36,   43,   54,   64,   72,   87,   104,  117,  128   144]
      y = [0.85, 0.7, 0.6, 0.43, 0.45, 0.43, 0.43, 0.43, 0.43, 0.43, 0.41, 0.4, 0.36, 0.34, 0.32, 0.3, 0.28, 0.26]
