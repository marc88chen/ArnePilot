...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      y = [0.6, 0.45, 0.43, 0.41, 0.38, 0.35, 0.34, 0.33, 0.32, 0.31, 0.3, 0.29, 0.28, 0.27, 0.22, 0.21, 0.2, 0.2]
      ...
      #km/h[0,  5,    10,    15,   19,  22,  25,  29,  36,  43,   54,   64,   72,   87,   104,  117,  128,  144]
      y = [2.6, 2.5, 2.4, 2.3, 2.2, 2.15, 2.15, 2.15, 2.1, 2, 1.8, 1.7, 1.7, 1.8, 2.1, 2.05, 1.4, 1.2]
      self.x_lead_mod_x = [4.1, 6.15, 8.24, 10 , 15 ]
    else:
      #km/h[0,   5,    10,   15,   19,  22,   25,   29,   36,   43,   54,   64,   72,   87,   104,  117,  128   144]
      y = [0.85, 0.7, 0.6, 0.43, 0.42, 0.41, 0.41, 0.41, 0.41, 0.4, 0.4, 0.38, 0.35, 0.31, 0.235, 0.23, 0.225, 0.22]
