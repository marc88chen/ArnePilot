...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      y = [0.6, 0.40, 0.38, 0.37, 0.36, 0.35, 0.34, 0.33, 0.32, 0.31, 0.3, 0.28, 0.26, 0.24, 0.22, 0.21, 0.20, 0.20]
      ...
      #km/h[0,  5,    10,    15,   19,  22,  25,  29,  36,  43,   54,   64,   72,   87,   104,  117,  128,  144]
      y = [1.1, 0.88, 0.77, 0.66, 0.57, 0.56, 0.55, 0.52, 0.5, 0.52, 0.55, 0.64, 0.64, 0.62, 0.45, 0.42, 0.41, 0.4]
      self.x_lead_mod_x = [4.1, 6.15, 8.24, 10 , 15 ]
    else:
      #km/h[0,   5,    10,   15,   19,  22,   25,   29,   36,   43,   54,   64,   72,   87,   104,  117,  128   144]
      y = [0.85, 0.7, 0.6, 0.43, 0.45, 0.43, 0.42, 0.41, 0.42, 0.43, 0.41, 0.36, 0.33, 0.32, 0.3, 0.28, 0.25, 0.24]
