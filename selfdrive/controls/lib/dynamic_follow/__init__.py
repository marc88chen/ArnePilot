...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.65, 1.66, 1.69, 1.72, 1.767, 1.798, 1.812, 1.823, 1.84, 1.865, 1.89, 1.935, 2.03, 2.1, 2.19, 2.3, 2.43, 2.6]
      profile_mod_pos = [0.33, 0.5, 1.05, 0.3, 0.35, 0.23, 0.13, 0.1]
      ...
      y_dist = [1.41, 1.42, 1.43, 1.43, 1.393, 1.32, 1.26, 1.2, 1.173, 1.163, 1.173, 1.2, 1.267, 1.33, 1.4, 1.5, 1.62, 1.8]
      profile_mod_pos = [0.33, 0.5, 1.05, 1.35, 1.45, 1.3, 1.1, 0.9]
      ...
      profile_mod_pos = [0.33, 0.5, 1.05, 1.0, 1.0, 0.9, 0.6, 0.4]
    ...
    y = [.9, 0.77, 0.623, 0.495, 0.32227, 0.322, 0.239, 0.12, 0.11, 0.08, 0.02, 0.0, -0.056, -0.0792, -0.15675, -0.23289, -0.315]  # modification values
