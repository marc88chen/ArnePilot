...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    profile_mod_x = [1, 2, 3, 8.3, 19.4, 28.4]  # profile mod speeds, mph: [5., 30., 55., 80.]
    ...
    if df_profile == PROFILE_LONG:
      ...
      profile_mod_pos = [0.26, 0.31, 0.38, 0.35, 0.23, 0.1]
      profile_mod_neg = [0.2, 0.4, 1.1, 1.3, 2.0, 2.3]
      ...
      profile_mod_pos = [0.26, 0.4, 1.22, 1.52, 1.52, 1.2]
      ...
      profile_mod_pos = [0.26, 0.3, 1.0, 1.1, 0.7, 0.55]
