...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      profile_mod_pos = [0.31, 0.32, 0.33, 0.34, 0.35, 0.23, 0.13, 0.1]
      ...
      y_dist = [1.401, 1.403, 1.405, 1.408, 1.408, 1.367, 1.3235, 1.28, 1.185, 1.163, 1.173, 1.2, 1.267, 1.33, 1.4, 1.5, 1.62, 1.8]
      profile_mod_pos = [0.32, 0.4, 0.5, 1.35, 1.45, 1.3, 1.1, 0.9]
      ...
      profile_mod_pos = [0.31, 0.4, 0.4, 1.0, 1.0, 0.9, 0.6, 0.4]
