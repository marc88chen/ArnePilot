...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      y_dist = [1.22, 1.23, 1.24, 1.26, 1.265, 1.27, 1.27, 1.27, 1.24, 1.24, 1.275, 1.31, 1.38, 1.48, 1.6, 1.76]
      profile_mod_pos = [0.92, 1.15, 1.1, 0.9, 0.7]
      profile_mod_neg = [0.9, 0.95, 0.9, 0.8, 0.7]
    elif df_profile == PROFILE_NORMAL:  # default to relaxed/stock
      y_dist = [1.33, 1.405, 1.48, 1.5129, 1.523, 1.5341, 1.5452, 1.5563, 1.5674, 1.5785, 1.597, 1.617, 1.65, 1.7, 1.7781, 1.88]
      profile_mod_pos = [0.99, 0.88, 0.77, 0.66, 0.4]
      profile_mod_neg = [0.9, 0.6, 0.6, 0.8, 0.8]
    else:
