...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.35, 1.4, 1.5, 1.6, 1.679, 1.74, 1.792, 1.833, 1.876, 1.92, 2.03, 2.1, 2.19, 2.3, 2.43, 2.6]
      profile_mod_pos = [0.5, 0.42, 0.33, 0.1, 0.088]
      ...
      y_dist = [1.36, 1.405, 1.48, 1.4996, 1.5098, 1.5248, 1.5401, 1.5462, 1.5580, 1.5698, 1.597, 1.617, 1.65, 1.7, 1.7781, 1.88]
