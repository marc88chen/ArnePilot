...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.47, 1.48, 1.49, 1.474, 1.8, 1.9, 2.0, 2.1, 2.2, 2.38, 2.46, 2.54, 2.6]  # TRs
      profile_mod_pos = [0.085, 0.23, 0.32, 0.38, 0.35, 0.23, 0.13, 0.1]
      profile_mod_neg = [0.3, 0.5, 0.4, 1.1, 1.3, 2.0, 2.3]
      ...
      y_dist = [1.23, 1.23, 1.28, 1.22, 1.16, 1.12, 1.0, 1.03, 1.05, 1.0, 1.05, 1.1]
      profile_mod_pos = [0.075, 0.9, 1.18, 1.58, 1.65, 1.2, 0.8]
      profile_mod_neg = [0.3, 0.8, 1.2, 0.6, 0.5, 0.4, 0.3]
    elif df_profile == PROFILE_NORMAL:  # default to relaxed/stock
      y_dist = [1.47, 1.48, 1.49, 1.474, 1.474, 1.474, 1.516, 1.534, 1.546, 1.568, 1.579, 1.593, 1.614]
      profile_mod_pos = [0.085, 0.3, 0.9, 1.0, 1.1, 0.7, 0.63, 0.55]
      profile_mod_neg = [0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.0]
    else:
