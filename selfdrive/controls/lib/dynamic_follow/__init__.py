...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      profile_mod_pos = [0.07, 0.3, 0.32, 0.38, 0.35, 0.23, 0.13, 0.1]
      ...
      profile_mod_pos = [0.08, 0.11, 1.37, 1.52, 1.52, 1.2, 0.8]
      ...
      profile_mod_pos = [0.07, 0.3, 0.9, 1.0, 1.1, 0.7, 0.63, 0.55]
