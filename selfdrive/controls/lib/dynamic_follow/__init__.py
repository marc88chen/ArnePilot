...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.56, 1.6, 1.64, 1.72, 1.767, 1.812, 1.834, 1.845, 1.859, 1.874, 1.9025, 1.935, 2.03, 2.1, 2.19, 2.3, 2.43, 2.6]
      ...
      y_dist = [1.2682, 1.275, 1.29, 1.324, 1.356, 1.3276, 1.3134, 1.28, 1.185, 1.163, 1.173, 1.2, 1.267, 1.33, 1.4, 1.5, 1.62, 1.8]
      profile_mod_pos = [0.2, 1.26, 1.24, 1.2, 1.15, 1.1]
      ...
      profile_mod_pos = [0.21, 1.0, 1.2, 1.1, 0.6, 0.4]
    ...
    y = [0.64, 0.56, 0.492, 0.3515, 0.2305, 0.1022, 0.0, -0.042, -0.053, -0.069, -0.089]  # modification values
