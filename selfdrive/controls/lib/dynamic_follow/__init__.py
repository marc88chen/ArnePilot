...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    profile_mod_x = [0.1, 0.2, 2.78, 8.3, 13.7, 19.4, 30.6, 38.9]  # profile mod speeds, kph: [.36, 1.1, 4, 10, 30, 70, 100, 130]
    ...
    if df_profile == PROFILE_LONG:
      ...
      profile_mod_pos = [0.24, 0.24, 0.23, 0.23, 0.23, 0.23, 0.13, 0.1]
      ...
      y_dist = [1.36, 1.375, 1.39, 1.424, 1.416, 1.3576, 1.3134, 1.28, 1.185, 1.163, 1.173, 1.2, 1.267, 1.33, 1.4, 1.5, 1.62, 1.8]
      profile_mod_pos = [0.28, 0.33, 0.44, 1.0, 1.25, 1.2, 1.1, 0.9]
      ...
      profile_mod_pos = [0.27, 0.34, 0.44, 1.1, 1.1, 1.0, 0.6, 0.4]
