...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    profile_mod_x = [0.25, 5.5, 16.7, 22.2, 30.6, 38.9]  # profile mod speeds, kph: [.36, 1.1, 4, 10, 30, 70, 100, 130]
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.62, 1.63, 1.64, 1.72, 1.767, 1.812, 1.834, 1.845, 1.859, 1.874, 1.9025, 1.935, 2.03, 2.1, 2.19, 2.3, 2.43, 2.6]
      profile_mod_pos = [0.23, 0.37, 0.45, 0.26, 0.13, 0.1]
      profile_mod_neg = [0.7, 0.7, 1.0, 1.1, 1.2, 1.3]
      ...
      y_dist = [1.26, 1.275, 1.29, 1.324, 1.356, 1.3276, 1.3134, 1.28, 1.185, 1.163, 1.173, 1.2, 1.267, 1.33, 1.4, 1.5, 1.62, 1.8]
      profile_mod_pos = [0.21, 1.26, 1.24, 1.2, 1.15, 1.1]
      profile_mod_neg = [1.2, 0.95, 0.9, 0.8, 0.7, 0.6]
      ...
      profile_mod_pos = [0.23, 0.9, 1.2, 1.1, 0.6, 0.4]
      profile_mod_neg = [0.9, 0.9, 0.9, 0.9, 0.8, 0.7]
    else:
    ...
    y = [0.64, 0.56, 0.492, 0.3515, 0.2305, 0.1022, 0.0, -0.0153, -0.042, -0.053, -0.059]  # modification values
