...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      profile_mod_pos = [0.31, 0.49, 1.04, 0.3, 0.35, 0.23, 0.13, 0.1]
      ...
      profile_mod_pos = [0.31, 0.49, 1.04, 1.35, 1.45, 1.3, 1.1, 0.9]
      ...
      profile_mod_pos = [0.31, 0.49, 1.04, 1.0, 1.0, 0.9, 0.6, 0.4]
