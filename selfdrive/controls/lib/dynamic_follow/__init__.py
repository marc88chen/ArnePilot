...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      profile_mod_pos = [0.3, 0.5, 1.05, 0.3, 0.35, 0.23, 0.13, 0.1]
      ...
      y_dist = [1.31, 1.32, 1.33, 1.33, 1.293, 1.28, 1.247, 1.2, 1.173, 1.163, 1.173, 1.2, 1.267, 1.33, 1.4, 1.5, 1.62, 1.8]
      profile_mod_pos = [0.3, 0.5, 1.05, 1.35, 1.45, 1.3, 1.1, 0.9]
      ...
      profile_mod_pos = [0.3, 0.5, 1.05, 1.0, 1.0, 0.9, 0.6, 0.4]
