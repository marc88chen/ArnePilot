...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.42, 1.45, 1.53, 1.633, 1.698, 1.751, 1.792, 1.833, 1.876, 1.92, 2.03, 2.1, 2.19, 2.3, 2.43, 2.6]
      profile_mod_pos = [0.7, 0.22, 0.27, 0.14, 0.1]
      ...
      profile_mod_pos = [0.82, 0.82, 0.82, 0.6, 0.4]
