...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.5, 1.55, 1.6, 1.651, 1.698, 1.748, 1.792, 1.833, 1.876, 1.92, 2.03, 2.1, 2.19, 2.3, 2.43, 2.6]
      ...
      y_dist = [1.29, 1.313, 1.325, 1.3276, 1.3134, 1.28, 1.22, 1.173, 1.173, 1.2, 1.27, 1.33, 1.4, 1.5, 1.62, 1.8]
      ...
      y_dist = [1.5, 1.5033, 1.51, 1.521, 1.5318, 1.5426, 1.5544, 1.5662, 1.5780, 1.5898, 1.617, 1.637, 1.67, 1.72, 1.7981, 1.9]
