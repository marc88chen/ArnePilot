...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      profile_mod_pos = [0.3, 0.38, 0.35, 0.23, 0.1]
      ...
      profile_mod_pos = [0.3, 1.22, 1.52, 1.52, 1.2]
      profile_mod_neg = [0.6, 1.2, 0.6, 0.5, 0.4]
      ...
      profile_mod_pos = [0.3, 1.0, 1.1, 0.7, 0.55]
      profile_mod_neg = [0.6, 1.0, 1.0, 1.0, 1.0]
    else:
