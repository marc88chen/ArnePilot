...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.5, 1.5033, 1.51, 1.5196, 1.5298, 1.6486, 1.792, 1.833, 1.876, 1.92, 2.03, 2.1, 2.19, 2.3, 2.43, 2.6]
      profile_mod_pos = [0.8, 0.8, 0.25, 0.13, 0.1]
      ...
      profile_mod_pos = [0.8, 0.8, 0.8, 0.6, 0.4]
