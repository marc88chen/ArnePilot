...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.5, 1.501, 1.502, 1.505, 1.6, 1.812, 1.834, 1.845, 1.859, 1.874, 1.9025, 1.935, 2.03, 2.1, 2.19, 2.3, 2.43, 2.6]
      profile_mod_pos = [0.4, 0.24, 0.24, 0.13, 0.1]
      ...
      profile_mod_pos = [1.1, 1.265, 1.2, 1.15, 1.1]
      ...
      profile_mod_pos = [0.9, 1.2, 1.1, 0.6, 0.4]
