...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      profile_mod_pos = [0.2, 0.26, 0.31, 0.38, 0.35, 0.23, 0.13, 0.1]
      ...
      profile_mod_pos = [0.07, 1.1, 1.35, 1.52, 1.52, 1.2, 0.8]
      ...
      profile_mod_pos = [0.07, 0.6, 0.8, 1.0, 1.1, 0.7, 0.63, 0.55]
