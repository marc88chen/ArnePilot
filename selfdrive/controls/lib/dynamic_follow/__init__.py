...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    profile_mod_x = [0.2, 1, 2, 3, 8.3, 19.4, 28.4, 33.3]  # profile mod speeds, mph: [5., 30., 55., 80.]
    ...
    if df_profile == PROFILE_LONG:
      ...
      profile_mod_pos = [0.22, 0.26, 0.31, 0.38, 0.35, 0.23, 0.13, 0.1]
      ...
      y_dist = [1.0, 1.2, 1.25, 1.05, 1.02, 1.0, 1.0, 1.03, 1.05, 1.0, 1.05, 1.1]
      profile_mod_pos = [0.3, 0.9, 1.22, 1.52, 1.52, 1.2, 0.8]
      profile_mod_neg = [0.3, 0.9, 1.2, 0.6, 0.5, 0.4, 0.3]
      ...
      profile_mod_pos = [0.25, 0.8, 0.6, 1.0, 1.1, 0.7, 0.63, 0.55]
