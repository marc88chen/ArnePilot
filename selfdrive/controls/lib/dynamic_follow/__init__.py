...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      y_dist = [1.2, 1.2, 1.25, 1.12, 1.05, 1.0, 1.0, 1.03, 1.05, 1.0, 1.05, 1.1]
      profile_mod_pos = [0.085, 0.11, 1.37, 1.52, 1.52, 1.2, 0.8]
      profile_mod_neg = [0.3, 1.1, 1.2, 0.6, 0.5, 0.4, 0.3]
      ...
      profile_mod_neg = [0.6, 0.7, 0.8, 1.0, 1.0, 1.0, 1.0]
    else:
