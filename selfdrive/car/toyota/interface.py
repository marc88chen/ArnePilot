      ...
      if spairrowtuning:
        ...
        for fw in car_fw:
          if fw.ecu == "eps" and fw.fwVersion == b"8965B42170\x00\x00\x00\x00\x00\x00":
            ...
            ret.lateralTuning.pid.kiV = [0.516, 0.516, 0.003, 0.003] # trajectory variance
            ret.lateralTuning.pid.kfV = [0.000078539816339744830961566084581988, 0.000078539816339744830961566084581988, 0.000078539816339744830961566084581988] # curvature
