...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if candidate == CAR.PRIUS:
      ...
      ret.longitudinalTuning.kiBP = [0., 5., 12., 20., 27.]
      ret.longitudinalTuning.kiV = [.28, .265, .22, .185, .12]
      ...
      if spairrowtuning:
        ...
        for fw in car_fw:
            ...
            ret.lateralTuning.pid.kiV = [0.8613, 0.8613, 0.03, 0.03] # trajectory variance
            ret.lateralTuning.pid.kfV = [0.000306527623515282, 0.000306527623515282, 0.000306527623515282] # curvature
            break
