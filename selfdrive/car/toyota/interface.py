    ...
    if candidate == CAR.PRIUS:
      ...
      if spairrowtuning:
        ...
        for fw in car_fw:
            ...
            ret.lateralTuning.pid.kpV = [0.6, 0.6, 0.6, 0.6, 0.6, 0.2, 0.2, 0.2] # power or torque
            ret.lateralTuning.pid.kiV = [0.513, 0.513, 0.513, 0.513, 0.513, 0.035, 0.035, 0.035] # trajectory variance
