      ...
      if spairrowtuning:
        ...
        for fw in car_fw:
          if fw.ecu == "eps" and fw.fwVersion == b"8965B42170\x00\x00\x00\x00\x00\x00":
            ...
            ret.lateralTuning.pid.kpV = [0.6, 0.6, 0.6, 0.6, 0.2, 0.15, 0.15] # bp turning force for RAV4TSS2 to take on most curves
            ret.lateralTuning.pid.kiV = [0.45, 0.45, 0.45, 0.45, 0.03, 0.025, 0.02] # ADP tends to deviate off course, so use lower ki values to remain on course
